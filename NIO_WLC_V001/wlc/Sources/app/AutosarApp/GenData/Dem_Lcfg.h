...
#define DEM_CFG_EQ2_OPCYCLETYPEOFCYCLEIDTABLE                         DEM_CFG_OPCYC_IGNITION
...
#define DEM_CFG_EQ2_OPERATIONCYCLEIDOFEVENTTABLE                      DemConf_DemOperationCycle_IgnitionCycle
...
#define DEM_CFG_EQ2_EVENTCOUNTOFSATELLITEINFO                         12u
#define DEM_CFG_EQ2_EVENTTABLEINDENDIDXOFSATELLITEINFO                12u
...
#define DEM_CFG_GLOBAL_CLEAR_DTC_RUNTIME_LIMIT                        12u                               /* not configured, here substituted by number of events (incl. event #0) */ 
...
#define DemConf_DemEventParameter_AutoCreatedDemEvent_ECUM_E_CONFIGURATION_DATA_INCONSISTENT  10u 
#define DemConf_DemEventParameter_AutoCreatedDemEvent_ECUM_E_IMPROPER_CALLER                  11u 
#define DemConf_DemEventParameter_DTC_0x000002                                                1u 
#define DemConf_DemEventParameter_DemEventParameter                                           2u 
#define DemConf_DemEventParameter_DemEventParameter_001                                       3u 
#define DemConf_DemEventParameter_DemEventParameter_002                                       4u 
#define DemConf_DemEventParameter_DemEventParameter_003                                       5u 
#define DemConf_DemEventParameter_DemEventParameter_004                                       6u 
#define DemConf_DemEventParameter_DemEventParameter_005                                       7u 
#define DemConf_DemEventParameter_DemEventParameter_006                                       8u 
...
#define DEM_CFG_GLOBAL_PRIMARY_LAST                                   11u          /* Highest EventID with DemEventDestination==DEM_DTC_ORIGIN_PRIMARY_MEMORY, or 0 if no such destination is configured. */ 
...
#define Dem_Cfg_GetSizeOfEventTableOfPCConfig()                       12u  /**< the number of accomplishable value elements in Dem_Cfg_EventTable */
...
#define Dem_Cfg_GetOpCycleTypeOfCycleIdTable(Index)                   DEM_CFG_OPCYC_IGNITION  /**< DemOperationCycleType of the DemOperationCycle: [DEM_CFG_OPCYC_IGNITION, DEM_CFG_OPCYC_OBD_DCY, DEM_CFG_OPCYC_OTHER, DEM_CFG_OPCYC_POWER, DEM_CFG_OPCYC_TIME, DEM_CFG_OPCYC_WARMUP, DEM_CFG_OPCYC_IGNITION_HYBRID, DEM_CFG_OPCYC_AGING] */
...
#define Dem_Cfg_GetOperationCycleIdOfEventTable(Index)                DemConf_DemOperationCycle_IgnitionCycle  /**< DemOperationCycle (ID) referenced by DemEventParameter/DemEventClass/DemOperationCycleRef */
...
#define Dem_Cfg_GetEventCountOfSatelliteInfo(Index)                   12u  /**< Satellite individual size of the monitor/event data RAM buffer */
#define Dem_Cfg_GetEventTableIndEndIdxOfSatelliteInfo(Index)          12u  /**< the end index of the 0:n relation pointing to Dem_Cfg_EventTableInd */
...
typedef struct Dem_Cfg_SatelliteInfoType0_s {
  volatile Dem_SatelliteData_DataType SatelliteData[ 12 ];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(Dem_MemoryEntry_HandleType, DEM_CONST) Dem_Cfg_MemoryBlockIdToMemoryEntryId[10];  /* PRQA S 0777 */  /* MD_MSR_5.1_777 */
#define DEM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern volatile VAR(Dem_Cfg_EventDebounceValueType, DEM_VAR_NOINIT) Dem_Cfg_EventDebounceValue[12];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern volatile VAR(Dem_Event_InternalStatusType, DEM_VAR_NOINIT) Dem_Cfg_EventInternalStatus[12];
#define DEM_STOP_SEC_VAR_NOINIT_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
