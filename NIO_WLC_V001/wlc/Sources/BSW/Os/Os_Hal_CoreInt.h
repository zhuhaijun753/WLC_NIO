 ...
 *  \pre           Supervisor mode.
 */
# define Os_Hal_DisableFE()       Os_Hal_SetPSW(Os_Hal_GetPSW() | 0x0080uL)                                             /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
 ...
 *  \pre           Supervisor mode.
 */
# define Os_Hal_SetEBVFlag()      Os_Hal_SetPSW(Os_Hal_GetPSW() | 0x8000uL)                                             /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
...
{
  uint32 CoreCount;
  P2CONST(Os_Hal_CoreAsrConfigType, OS_CONST, OS_CONST) CoreConfigRefs[OS_HAL_CFG_CORE_COUNT+1u];
};
