...
#------------------------------------------------------------------------------
# 1.00.00   2015-11-27  Sat     Initial Version derived from Il_AsrCom (2.01.00)
...
LIBRARIES_TO_BUILD      += CddDk4
CddDk4_FILES               = CddDk4$(BSW_SRC_DIR)\CddDk4.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += CddDk4$(BSW_SRC_DIR)\CddDk4.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CddDk4_Cfg.c
